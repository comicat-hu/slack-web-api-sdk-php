...
class AdminConversationsRestrictAccessRemoveGroup extends \Comicat\Slack\Api\Runtime\Client\BaseEndpoint implements \Comicat\Slack\Api\Runtime\Client\Endpoint
{
    /**
    ...
    protected function getFormOptionsResolver() : \Symfony\Component\OptionsResolver\OptionsResolver
    {
        ...
        $optionsResolver->setRequired(array('token', 'team_id', 'group_id', 'channel_id'));
     ...
     *
     *
     * @return null|\Comicat\Slack\Api\Model\AdminConversationsRestrictAccessRemoveGroupPostResponse200|\Comicat\Slack\Api\Model\AdminConversationsRestrictAccessRemoveGroupPostResponsedefault
     */
    protected function transformResponseBody(string $body, int $status, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        if (200 === $status) {
            return $serializer->deserialize($body, 'Comicat\\Slack\\Api\\Model\\AdminConversationsRestrictAccessRemoveGroupPostResponse200', 'json');
        }
        return $serializer->deserialize($body, 'Comicat\\Slack\\Api\\Model\\AdminConversationsRestrictAccessRemoveGroupPostResponsedefault', 'json');
    }
