...
class FilesUpload extends \Comicat\Slack\Api\Runtime\Client\BaseEndpoint implements \Comicat\Slack\Api\Runtime\Client\Endpoint
{
    /**
    ...
    protected function getFormOptionsResolver() : \Symfony\Component\OptionsResolver\OptionsResolver
    {
        ...
        $optionsResolver->setDefined(array('token', 'file', 'content', 'filetype', 'filename', 'title', 'initial_comment', 'channels', 'thread_ts'));
