...
class ObjsUserItem0Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Comicat\\Slack\\Api\\Model\\ObjsUserItem0';
    }
    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'Comicat\\Slack\\Api\\Model\\ObjsUserItem0';
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Comicat\Slack\Api\Model\ObjsUserItem0();
        ...
        if (\array_key_exists('is_invited_user', $data)) {
        ...
        if (\array_key_exists('team_profile', $data)) {
            $object->setTeamProfile($this->denormalizer->denormalize($data['team_profile'], 'Comicat\\Slack\\Api\\Model\\ObjsUserItem0TeamProfile', 'json', $context));
        }
