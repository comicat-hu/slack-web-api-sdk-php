...
class UsersConversationsGetResponse200ResponseMetadataNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Comicat\\Slack\\Api\\Model\\UsersConversationsGetResponse200ResponseMetadata';
    }
    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'Comicat\\Slack\\Api\\Model\\UsersConversationsGetResponse200ResponseMetadata';
    }
